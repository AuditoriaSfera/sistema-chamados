...
INSERT INTO "new_PerfilAcesso" ("ativo", "cor", "createdAt", "escopoChamados", "id", "nome", "ordem", "podeAbrirChamado", "podeAlterarStatus", "podeCancelarReabrirProprio", "podeGerenciarCadastros", "podeResponderChat", "podeVerRelatorios") SELECT "ativo", "cor", "createdAt", "escopoChamados", "id", "nome", "ordem", "podeAbrirChamado", "podeAlterarStatus", "podeCancelarReabrirProprio", "podeGerenciarCadastros", "podeResponderChat", "podeVerRelatorios" FROM "PerfilAcesso";
